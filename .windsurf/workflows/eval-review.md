...
```bash
AUDITOR_MODEL=$(node "D:/agoravai/.windsurf/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/agoravai/.windsurf/agents/gsd-eval-auditor.md for instructions.
