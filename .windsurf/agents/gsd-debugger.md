...
<required_reading>
@D:/agoravai/.windsurf/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/agoravai/.windsurf
                  → checks D:/agoravai/.windsurf/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/agoravai/.windsurf/get-shit-done
                  → writes to D:/agoravai/.windsurf/get-shit-done/hooks/
...
@D:/agoravai/.windsurf/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/agoravai/.windsurf/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/agoravai/.windsurf/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/agoravai/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/agoravai/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
