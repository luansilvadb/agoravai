...
Use template from `D:/agoravai/.windsurf/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/agoravai/.windsurf/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/agoravai/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
