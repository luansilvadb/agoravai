...
- [x] 5.2 Define copy tasks for: .windsurf/workflows, specskill/changes, .rag/context
...
- [ ] 7.2 Test postinstall execution locally with `npm run postinstall`
- [ ] 7.3 Verify all 3 copy tasks execute (windsurf workflows, specskill changes, rag context)
- [ ] 7.4 Verify error handling produces correct exit codes
